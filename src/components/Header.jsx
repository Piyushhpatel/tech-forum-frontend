...
const Header = () => {
  return (
    <div>
      <div className="flex justify-between max-w-[1600px] bg-slate-800 rounded-3xl  max-h-[100px] p-6 mx-10 lg:mx-auto">
        ...
        <div className="lg:max-w-[400px] lg:w-full">
            <form className="hidden lg:flex w-full">
                <input
                    ...
                    name="search"
                    placeholder="Search"
                    className="rounded-2xl focus:outline-none outline-none w-full p-2 rounded-r-none"
                />
